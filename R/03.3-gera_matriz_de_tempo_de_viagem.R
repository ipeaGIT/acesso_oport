...
gerar_tt_matrix <- function(ano, munis = "all") {
...
juntar_output_OTP <- function(ano, munis = "all") {
  ...
  # Aplicar funcao
  pbapply::pblapply(x, FUN=juntar_output_OTP_muni)

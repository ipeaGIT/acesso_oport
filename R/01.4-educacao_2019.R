...
# get coordinatess from 2018 (previous year)
escolas_2018_geo <- read_rds("../../data/acesso_oport/censo_escolar/2018/educacao_inep_final_2018.rds") %>%
...
escolas_2018_geo %>% filter(co_entidade %in% escolas_geo$co_entidade)

escolas_geo[, co_entidade := as.character(co_entidade)]
escolas_geo[escolas_2018_geo, on = "co_entidade", 
...
munis_problemaB <- subset(escolas_geo, co_entidade %in% B_muni_fora$co_entidade ) # 25 obs
...
enderecos <- munis_problema_enderecos$endereco # 699 obs
...
if (!dir.exists("../../data/acesso_oport/censo_escolar/2019/geocode/")) {
  dir.create("../../data/acesso_oport/censo_escolar/2019/geocode/")
}

# save
write_rds(coordenadas_google1, "../../data/acesso_oport/censo_escolar/2019/geocode/escolas_geocode_2019_output_google1.rds")
coordenadas_google1 <- read_rds("../../data/acesso_oport/censo_escolar/2019/geocode/escolas_geocode_2019_output_google1.rds")
...
unique(estabs_problema_geocoded_dt$co_entidade) %>% length() # 699
...
write_rds(escolas_geo,
          "../../data/acesso_oport/censo_escolar/2019/censo-escolar_escolas_geocoded_2019.rds")
...
# abrir
escolas_censo <- read_rds("../../data/acesso_oport/censo_escolar/2019/censo-escolar_escolas_geocoded_2019.rds") %>%
  select(colunas) %>%
...
# salvar
write_rds(escolas_etapa_fim, "../../data/acesso_oport/censo_escolar/2019/educacao_inep_final_2019.rds")

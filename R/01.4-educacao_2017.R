...
# save
write_rds(coordenadas_google1, "../../data/acesso_oport/censo_escolar/2017/geocode/escolas_geocode_2017_output_google1.rds")
...
write_rds(escolas_geo,
          "../../data/acesso_oport/censo_escolar/2017/censo-escolar_escolas_geocoded_2017.rds")
...
# abrir
escolas_censo <- read_rds("../../data/acesso_oport/censo_escolar/2017/censo-escolar_escolas_geocoded_2017.rds") %>%
  select(colunas) %>%
...
# salvar
write_rds(escolas_etapa_fim, "../../data/acesso_oport/censo_escolar/2017/educacao_inep_final_2017.rds")

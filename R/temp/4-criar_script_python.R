...
# COMEÇA AQUI O SCRIPT ----------------------------------------------------
  ...
  "",
  "  # Save the result",
  sprintf("  matrixCsv.save('../data/output_ttmatrix/ttmatrix_%s_pt_%s_'+ str(h)+\"-\"+str(m) + '.csv')", municipio, res),
  "",
  ...
  "",
  "    # Save the result",
  sprintf("    matrixCsv.save('../data/output_ttmatrix/ttmatrix_%s_walk_%s.csv')", municipio, res),
  "    gc.collect()",
  "",
  "",
  "",
  ...
  "",
  "    # Save the result",
  sprintf("    matrixCsv.save('../data/output_ttmatrix/ttmatrix_%s_bike_%s.csv')", municipio, res),
  "    gc.collect()",
  "",
  "",
  "",

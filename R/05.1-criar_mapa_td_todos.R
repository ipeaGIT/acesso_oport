...
fazer_plot_1 <- function(sigla_muni, cols = 2) {
  ...
  # abrir tiles
  map_tiles <- read_rds(sprintf("../data/map_tiles_crop/map_tile_crop_%s.rds", sigla_muni))
...
fazer_plot_2 <- function(sigla_muni, cols = 2) {
  ...
  # save map
  ggsave(plot2, 
         file= sprintf("../figures/td_todas/fig2-%s_TMI_EI_walk.png", sigla_muni),
         dpi = 300, width = 14, height = 10, units = "cm")
}
...
fazer_plot_3 <- function(sigla_muni, cols = 2) {
  ...
  ggsave(plot3, 
         file= sprintf("../figures/td_todas/fig3-%s_CMA_TQ_1545.png", sigla_muni), 
         dpi = 300, width = 14, height = 10, units = "cm")
}
...
fazer_plot_4 <- function(sigla_muni, cols = 2) {
  ...
  ggsave(plot4, 
         file= sprintf("../figures/td_todas/fig4-%s_CMA_TQEF_60.png", sigla_muni),
         dpi = 300, width = 14, height = 10, units = "cm")

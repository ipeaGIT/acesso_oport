...
# COMEÇA AQUI O SCRIPT ----------------------------------------------------
  ...
  "    # Create a CSV output",
  "    matrixCsv = otp.createCSVOutput()",
  "    matrixCsv.setHeader([ 'city', 'mode', 'depart_time', 'origin', 'destination', 'walk_distance', 'travel_time' ]) # travel_time in seconds",
  "",
  "    # Start Loop",
  "    for origin in points:",
  ...
  "    # Create a CSV output",
  "    matrixCsv = otp.createCSVOutput()",
  "    matrixCsv.setHeader([ 'city', 'mode', 'depart_time', 'origin', 'destination', 'bike_distance', 'travel_time' ]) # travel_time in seconds",
  "",
  "    # Start Loop",
  "    for origin in points:",

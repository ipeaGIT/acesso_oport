...
# COMEÇA AQUI O SCRIPT ----------------------------------------------------
  ...
  sprintf("points = otp.loadCSVPopulation('points/points_corrigido_%s_09.csv', 'Y', 'X')", sigla_muni),
  sprintf("dests = otp.loadCSVPopulation('points/points_corrigido_%s_09.csv', 'Y', 'X')", sigla_muni),
  "",
  "",
  "",
  "",

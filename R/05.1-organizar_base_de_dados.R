...
# salvar rds
write_rds(a_sf, "../data/output_base_final/dados2019_AcessOport_v1.0_20200116.rds", compress = "gz")


# salvar dados em geopackage
st_write(a_sf, "../data/output_base_final/dados2019_AcessOport_v1.0_20200116.gpkg")

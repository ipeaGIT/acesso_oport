...
acess_acumu <- function(cidade, modo, hora, tempo, res = "08") {
  ...
  dir_matriz <- sprintf("../data/output_ttmatrix/ttmatrix_%s_%s_%s_%s.csv", cidade, modo, res1, hora)
...
acess_ac_for %>%
 select(saude_total, tempo_viagem) %>%
  ...
  theme_proj(legend.position ="bottom")+

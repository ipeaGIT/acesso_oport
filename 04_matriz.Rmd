...
```{r fun_criar_pontos_allres, code = readLines("R/4-criar_pontos_allres.R")}


```

```{r aplicar_criar_pontos_allres}
...
```{r fun_aplicar_otp, code = readLines("R/4-aplicar_otp.R")}
...
```{r tabela_parametros_otp, eval = TRUE}

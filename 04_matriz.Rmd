...
write_csv(for_hex_centroids, "../otp/points.csv")
...
command <- "java -jar programs/jython.jar -Dpython.path=programs/otp.jar  python_script_fortaleza.py"
...
Resultado: o método em python levou `r bench_r["elapsed"]` e o método em python levou `r bench_py["elapsed"]`.

Aplicando o método em python para rioo Horizonte:
...
command <- "java -jar programs/jython.jar -Dpython.path=programs/otp.jar  python_script_bel.py"
...
command <- "java -jar programs/jython.jar -Dpython.path=programs/otp.jar  python_script_rio.py"

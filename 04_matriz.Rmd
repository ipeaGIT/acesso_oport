...
# Criar arquivo em python em paralelo, entre 7 e 9 da manha, e para todos os modos
criar_script_python_paral_modes("for", modo = "tp", data = dia, from = 7, until = 8, every = 30)
...
# Criar arquivo em python em paralelo, entre 7 e 9 da manha, e para todos os modos
criar_script_python_paral_modes("bel", modo = "tp", data = dia, from = 7, until = 8, every = 30)
...
# Criar arquivo em python em paralelo, entre 7 e 9 da manha, e para todos os modos
criar_script_python_paral_modes("rio", data = dia, from = 7, until = 8, every = 30)

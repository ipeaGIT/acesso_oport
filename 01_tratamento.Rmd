...
Em seguida, os dados estatísticos do setores do censo são tratados: é feita a retirada das variáveis relacionadas à renda e à quantidade de pessoas, depois é feito o cálculo da renda por pessoa.
...
É feita então a junção dos shapes com as estatísticas, resultando numa base dos setores censitários georreferenciada, dividida por uf, com informações de renda e habitantes.
...
# funcao para criar arquivo para cada estado

setores_variaveis1 <- setores_total_v1[[1]]
setores_shapes1 <- setores_shapes[[1]]

...
A função ``agrupar_variaveis`` aceita como _input_ o nome do município desejado e retorna um tabela com o shape dos hexágonos e a quantidade de estabelecimentos de saúde, educação e população agregados.
